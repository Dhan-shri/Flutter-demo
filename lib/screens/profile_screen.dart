...
import 'package:untitled/widgets/layout_builder_widget.dart';
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  Text("Book Tickets", style: Styles.headLineStyles1,),
          ...
          Stack(
            children: [
              Container(
                ...
                width: double.infinity, // whatever required width take that
                decoration: BoxDecoration(
                    ...
                    Column(
                      ...
                      children: [
                        Text(
                          ...
                          style: Styles.headLineStyles2.copyWith(fontWeight: FontWeight.bold, color: Colors.white),
                        ),
                        Text(
                          "You have 95 flights in a year",
                          style: Styles.headLineStyles2.copyWith(fontWeight: FontWeight.w500, color: Colors.white.withOpacity(0.9), fontSize: 16),
                        ),
                      ],
                    )
                  ],
          ...
          Text("Accumulated miles", style: Styles.headLineStyles2,),
            ...
            child: Column(
              children: [
                ...
                Row(
                  ...
                  children: [
                    Text("Miles accured", style: Styles.headLineStyles4.copyWith(fontSize: 16 ),),
                    Text("03 Jan 2023", style: Styles.headLineStyles4.copyWith(fontSize: 16 ),),
                  ],
                ),
                ...
                Row(
                  ...
                  children: const [
                    ...
                    AppColumnLayout(firstText: "Exumea", secondText: "Received from", alignment: CrossAxisAlignment.end, isColor: false,)
                  ],
                ),
              ],
            ),
