          ...
          children: [
            ...
            Container(
              decoration: BoxDecoration(
                // if its null use first color or use second color
              ...
              child: Column(
                children: [
                  Row(
                    children: [
                      Text(ticket['from']['code'],
                          style: isColor == null? Styles.headLineStyles3.copyWith(color: Colors.white): Styles.headLineStyles3),
                      // const Spacer(), we can use as below also
                  ...
                  Row(
                    ...
                    children: [
                      SizedBox(
                        width: AppLayout.getWidth(100), child: Text(ticket['from']['name'], style: isColor == null? Styles.headLineStyles4.copyWith(color: Colors.white): Styles.headLineStyles4),
                      ),
                      Text(ticket['flying_time'], style: isColor == null? Styles.headLineStyles4.copyWith(color: Colors.white):Styles.headLineStyles4),
                      SizedBox(
                        width: AppLayout.getWidth(100), child: Text(ticket['to']['name'], textAlign: TextAlign.end, style: isColor == null? Styles.headLineStyles4.copyWith(color: Colors.white): Styles.headLineStyles4),
                      ),
                    ],
                  )
                ],
                ...
                children: [
                  Row(
                    ...
                    children: [
                      ...
                      AppColumnLayout(firstText: ticket['number'].toString(), secondText: "Number", alignment: CrossAxisAlignment.center, isColor: isColor ),
